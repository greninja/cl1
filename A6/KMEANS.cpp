...
/*
sahil@sahil-Inspiron-3521:~/BE/CL1/A6$ g++ KMEANS.cpp 
sahil@sahil-Inspiron-3521:~/BE/CL1/A6$ ./a.out 

Enter the number of clusters you want to create : 4
...
Cluster 1 centre is : (1.5,1.5)
Objects are: 
(1,1)
(2,2)
Cluster 2 centre is : (-1.5,1.5)
Objects are: 
(-1,1)
(-2,2)
Cluster 3 centre is : (1.5,-1.5)
Objects are: 
(1,-1)
(2,-2)
Cluster 4 centre is : (-1.5,-1.5)
Objects are: 
(-1,-1)
(-2,-2)
----------------------------------------------------------
