...
static const char *const yytname[] =
{
  ...
  "LP", "RP", "END", "$accept", "line1", "exp", "term", "factor", YY_NULLPTR
};
#endif
...
#line 33 "ast.y" /* yacc.c:1646  */
    {char buf[10];snprintf(buf,sizeof(buf),"%d",yylval);(yyval)=mknode(0,0,buf);}
